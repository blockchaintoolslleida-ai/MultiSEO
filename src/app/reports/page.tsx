    ...
    <div>
      ...
      <div className="grid grid-cols-4 gap-3 mb-5">
        {[
          ...
          { value: s.scheduled, label: "Programados", bg: "bg-purple-50", color: "text-purple-600" },
          ...
          <div key={label} className="bg-white border border-gray-200 rounded-[10px] p-3.5 flex items-center gap-3">
            <div className={`w-10 h-10 rounded-[10px] flex items-center justify-center ${bg}`}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={color}>
                <path d={label === "Total Reportes" ? "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z M14 2 14 8 20 8 M16 13H8 M16 17H8 M10 9H9H8" : label === "Enviados" ? "M22 11.08V12a10 10 0 1 1-5.93-9.14 M22 4 12 14.01 9 11.01" : label === "Programados" ? "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" : "M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7 M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"}/>
              </svg>
            </div>
