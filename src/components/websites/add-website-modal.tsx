...
import type { AccessType } from "@/types/seo";
...
export function AddWebsiteModal({ onSave, onClose }: AddWebsiteModalProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : "Error al crear el website");
    } finally {
      setSaving(false);
    }
  };
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-xl shadow-2xl border border-gray-200 w-full max-w-md mx-4 p-6">
        <div className="flex items-center justify-between mb-5">
          <h2 className="text-lg font-bold text-gray-900">Añadir Website</h2>
          <button
            onClick={onClose}
